 ...
 *
 * Original pin mapping for hardware versions used below 2.2.
 */
class BoardConfigV1 : public BoardConfig
{
  public:
    BoardConfigV1() = default;
    ~BoardConfigV1() override = default;
 ...
 *
 * Updated pin mapping for ESP32-S3 hardware usually used for versions above 2.2.
 * Modify pin assignments here as needed for the new board layout
 */
class BoardConfigV2_2 : public BoardConfig
{
  public:
    BoardConfigV2_2() = default;
    ~BoardConfigV2_2() override = default;
