...
const BoardVersion::VersionThreshold BoardVersion::_versionMap[] = {
    ...
    {0, 1900, HardwareVersion::V1_X},   // < 1.53V (~1900) = baseline v1.x with 100k/100k
    {1901, 4095, HardwareVersion::V2_2} // > 1.53V = v2.2 with modified resistor values (ESP32-S3)
};
...
const char* BoardVersion::getVersionString() const
{
    switch (_version)
    {
        case HardwareVersion::V1_X:
            return "v1.x";
        case HardwareVersion::V2_2:
            return "v2.2";
